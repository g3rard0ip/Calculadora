...
var Calculadora = {
    ...
    crearListeners: function() {
        ...
        document.getElementById("dividido").addEventListener("click", function() {
            Calculadora.callback(self.pantalla.textContent, "/");
            self.pantalla.textContent = ""
        })
        ...
        document.getElementById("igual").addEventListener("click", function() {
            var num2 = self.pantalla.textContent;
            Calculadora.resolver(num2);
        })
    },
    resolver: function(num2) {
        var resultado = 0;
        switch (this.signoResolver) {
            case "+":
                resultado = parseFloat(this.numAuxiliar) + parseFloat(num2);
                break;
            case "-":
                resultado = parseFloat(this.numAuxiliar) - parseFloat(num2);
                break;
            ...
            case "*":
                ...
                break;
            default:
                alert("Primero ingrese una operación a realizar")
                break;
        }
        this.numAuxiliar = 0;
        document.getElementById('display').textContent = resultado.toString().substring(0,8)
    },
    callback: function(numero, signo) {
        this.numAuxiliar = numero;
        this.signoResolver = signo;
    }
}
Calculadora.init();
